            ...
            child: Row(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("\n\n\n     You can update your password now if you've forgotten it.",style: TextStyle(color: Colors.grey.shade700,fontWeight: FontWeight.w500,fontSize: 12),),
                    SizedBox(height: 80,),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        SizedBox(width: 200,),
                        Text('\n\n\n Update password?',style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold,fontSize: 12),),
                        Container(height: 30,
                          width: 80,
                          margin: EdgeInsets.only(top: 45,left: 45,right: 8),
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(30),
                            color: Colors.blue.shade700,
                          ),
                          alignment: Alignment.center,
                          child: Text('Continue',style: TextStyle(color: Colors.white,fontSize: 11),),)
